...
with st.sidebar:
    ...
    with st.expander("💰 Gestão de Banca", expanded=False):
        ...
        st.session_state['ia_profunda_ativada'] = st.checkbox("🧠 IA Tier 2 (H2H/Momentum)", value=st.session_state.get('ia_profunda_ativada', False), help="Consome mais API mas melhora análise")
