...
def gerar_insights_matinais_ia(api_key):
    ...
    try:
        ...
        try:
            ...
            macro = analisar_tendencia_50_jogos(api_key, home_id, away_id) if _bet365_ok else None
            
            # 3. DADOS MICRO (MOMENTO - 10 JOGOS)
            micro = analisar_tendencia_macro_micro(api_key, home_id, away_id) if _bet365_ok else None
            
            if _bet365_ok and macro and micro:
