                ...
                if deve_enviar:
                    ...
                    if tipo_msg == "GREEN" and key_green not in st.session_state['alertas_enviados']:
                         try:
                            ...
                            try:
                                stake_str_g = str(s.get('Stake_Recomendado_RS', '')).replace('R$','').replace('.','').replace(',','.').strip()
                                if stake_str_g: stake_g = float(stake_str_g)
                            except: pass
                            odd_g = 1.50
                         ...
                         try:
                            ...
                            try:
                                stake_str_r = str(s.get('Stake_Recomendado_RS', '')).replace('R$','').replace('.','').replace(',','.').strip()
                                if stake_str_r: stake_r = float(stake_str_r)
                            except: pass
