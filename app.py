...
- {txt_pessoal}
        ...
        SUA MISSÃO: Preencher as 3 listas abaixo.
        
        REGRA CRÍTICA: Retorne NO MÍNIMO 3 jogos DIFERENTES (pode ser 1 de cada zona ou vários da mesma).
        
        SAÍDA OBRIGATÓRIA (VISUAL LIMPO E DIRETO):
        
        🔥 **ZONA DE GOLS (OVER)**
        ⚽ Jogo: [Nome completo sem parênteses] x [Nome completo sem parênteses]
        🏆 Liga: [Nome da liga]
        ...
        IMPORTANTE: 
        - Retorne NO MÍNIMO 3 jogos diferentes
