...
def verificar_mercados_bet365(api_key, fid):
    ...
    """
    resultado = {'cartoes': False, 'escanteios': False, 'jogador': False, 'gols': False}
    try:
        ...
        st.session_state[cache_key] = resultado
        print(f"[NEVES B365] FID {fid}: Cartões={resultado['cartoes']} | Escanteios={resultado['escanteios']} | Jogador={resultado['jogador']}")
