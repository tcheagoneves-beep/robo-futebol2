...
def calcular_threshold_dinamico(estrategia, odd_atual):
    """
    [CORRIGIDO v7.0] Função que FALTAVA e causava 100% de vetos.
    Agora retorna 0 para NUNCA vetar automaticamente.
    Sinais são sempre enviados com classificação para o apostador decidir.
    """
    return 0
...
def gerar_insights_matinais_ia(api_key):
    ...
    try:
        ...
        try:
            ...
            # [CORRIGIDO v7.0] Se NÃO tem na Bet365, PULA o jogo
