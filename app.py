                ...
                if deve_enviar:
                    ...
                    if tipo_msg == "GREEN" and key_green not in st.session_state['alertas_enviados']:
                         try:
                            ...
                            banca_g = round(float(st.session_state.get('banca_atual', st.session_state.get('banca_inicial', 1000.0))), 2)
                         ...
                         try:
                            ...
                            banca_r = round(float(st.session_state.get('banca_atual', st.session_state.get('banca_inicial', 1000.0))), 2)
                                ...
                                try:
                                    ...
                                    if prob_num_kelly > 0 and odd_val > 1.0:
                                        ...
                                        if kelly_res and kelly_res['valor'] > 0:
                                            kelly_info = f"├─ 💰 <b>Stake:</b> R$ {kelly_res['valor']:.2f} ({kelly_res['porcentagem']:.1f}%) Kelly\n"
                                except: pass
